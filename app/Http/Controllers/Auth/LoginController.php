...
class LoginController extends Controller
{
    ...
    */
    ...
    protected function getUserByCredentials(Request $request)
    {
        return Auth::getProvider()->retrieveByCredentials($this->credentials($request));
    }
    ...
    protected function sendInactiveUserResponse(Request $request)
    {
        throw ValidationException::withMessages([
            $this->username() => ['User not approved by admin'],
        ]);
    }
}
