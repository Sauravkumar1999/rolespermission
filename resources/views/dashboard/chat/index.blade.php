        ...
        <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
            <div class="chat-leftsidebar">
                ...
                <ul class="nav nav-tabs nav-tabs-custom nav-success nav-justified" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#chats"
                            role="tab">Chats</a></li>
                        ...
                        <div class="chat-room-list" data-simplebar>
                            <ul class="list-group" id="contact-list">
                                @foreach ($users as $user)
                                    <li class="list-group-item list-group-item-action clicktochat"
                            ...
                            <div class="position-relative" id="users-chat">
                                ...
                                <div class="chat-conversation p-3 p-lg-4 " id="chat-conversation" data-simplebar>
                                    ...
                                    <ul class="list-unstyled chat-conversation-list" id="users-conversation">
                                        <li class="chat-list right" id="chat-list-4">
                                            <div class="conversation-list">
                                                <div class="user-chat-content">
                                                    <div class="ctext-wrap">
                                                        <div class="ctext-wrap-content">
                                                            <p class="mb-0 fst-normal">Hellow How are you </p>
                                                        </div>
                                                    </div>
