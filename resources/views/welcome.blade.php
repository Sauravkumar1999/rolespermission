...
<body class="antialiased">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="{{ route('chat.index')}}"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed" id="messageShow">
                            </p>
                        </div>
    ...
    {{-- <script src="{{ asset('build/assets/app-lnkM17G3.js') }}"></script>
    <script>
        Echo.channel('hellow-saurav').listen('SendMessage', (e) => {
            let p = document.getElementById('messageShow')
            p.innerHTML = e.data;
        })
    </script> --}}
</body>
